		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ReportedeConductores-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ReportedeConductores-display": {
								"semanticObject": "ReportedeConductores",
								"action": "display",
								"description": "Listado de Conductores",
								"title": "Reporte de Conductores",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ypf.zlog12freeld4",
									"url": sap.ui.require.toUrl("ypf/zlog12freeld4")
								}
							}
						}
					}
