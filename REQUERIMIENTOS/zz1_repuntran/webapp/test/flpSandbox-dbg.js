		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ReportedeVehículos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ReportedeVehículos-display": {
								"semanticObject": "ReportedeVehículos",
								"action": "display",
								"description": "Listado de vehículos y detalle",
								"title": "Reporte de Vehículos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ypf.zlog66freeld4",
